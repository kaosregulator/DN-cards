...
const RARITY_FRAMES: Record<Rarity, [Frame, Frame, Frame]> = {
  common: [
    ...
    { id: "common_iron", name: "Iron Edge", emoji: "🔩", rarity: "common", unlockLevel: 5, color: 0x808b96, wrap: plain("┃", "┃") },
    { id: "common_slate", name: "Slate", emoji: "◾", rarity: "common", unlockLevel: 10, color: 0x5d6d7e, wrap: plain("▪", "▪") },
  ],
  uncommon: [
    { id: "uncommon_default", name: "Verdant", emoji: "🟢", rarity: "uncommon", unlockLevel: 1, color: 0x2ecc71, wrap: plain("⟨", "⟩") },
    { id: "uncommon_leaf", name: "Leafbound", emoji: "🍃", rarity: "uncommon", unlockLevel: 5, color: 0x27ae60, wrap: plain("❨", "❩") },
    { id: "uncommon_jade", name: "Jade", emoji: "💚", rarity: "uncommon", unlockLevel: 10, color: 0x1abc9c, wrap: plain("༺", "༻") },
  ],
  rare: [
    { id: "rare_default", name: "Azure", emoji: "🔵", rarity: "rare", unlockLevel: 1, color: 0x3498db, wrap: plain("⟨", "⟩") },
    { id: "rare_tide", name: "Tidecaller", emoji: "🌊", rarity: "rare", unlockLevel: 5, color: 0x2980b9, wrap: plain("❨", "❩") },
    { id: "rare_frost", name: "Frostline", emoji: "❄️", rarity: "rare", unlockLevel: 10, color: 0x5dade2, wrap: plain("༺", "༻") },
  ],
  epic: [
    { id: "epic_default", name: "Amethyst", emoji: "🟣", rarity: "epic", unlockLevel: 1, color: 0x9b59b6, wrap: plain("⟨", "⟩") },
    { id: "epic_arcane", name: "Arcane", emoji: "🔮", rarity: "epic", unlockLevel: 5, color: 0x8e44ad, wrap: plain("❰", "❱") },
    { id: "epic_void", name: "Voidtouched", emoji: "🌌", rarity: "epic", unlockLevel: 10, color: 0x6c3483, wrap: plain("༺", "༻") },
  ],
  legendary: [
    { id: "legendary_default", name: "Golden", emoji: "🟡", rarity: "legendary", unlockLevel: 1, color: 0xf1c40f, wrap: plain("⟨", "⟩") },
    { id: "legendary_sunfire", name: "Sunfire", emoji: "☀️", rarity: "legendary", unlockLevel: 5, color: 0xf39c12, wrap: plain("❰", "❱") },
    { id: "legendary_royal", name: "Royal Crest", emoji: "👑", rarity: "legendary", unlockLevel: 10, color: 0xe67e22, wrap: plain("♜", "♜") },
  ],
  mythic: [
    { id: "mythic_default", name: "Mythic", emoji: "🔴", rarity: "mythic", unlockLevel: 1, color: 0xe74c3c, wrap: plain("⟨", "⟩") },
    { id: "mythic_ember", name: "Ember Rift", emoji: "🔥", rarity: "mythic", unlockLevel: 5, color: 0xc0392b, wrap: plain("❰", "❱") },
    { id: "mythic_celestial", name: "Celestial", emoji: "✨", rarity: "mythic", unlockLevel: 10, color: 0xff5e78, wrap: plain("༺✧", "✧༻") },
  ],
};
