...
export const HQ_DECORATIONS: HqDecoration[] = [
  ...
  { id: "welcome-rug", name: "Welcome Rug", emoji: "🟥", rarity: "common", category: "rug",
    spriteKey: "deco/welcome-rug", unlock: { kind: "always" }, story: "Soft underfoot from day one." },
  ...
  { id: "woven-rug", name: "Woven Rug", emoji: "🧶", rarity: "common", category: "rug",
    spriteKey: "deco/woven-rug", unlock: { kind: "always" }, price: 160, drop: true, story: "Soft underfoot — ties the room together." },
  ...
  { id: "storage-barrel", name: "Storage Barrel", emoji: "🛢️", rarity: "common", category: "case",
    spriteKey: "deco/storage-barrel", unlock: { kind: "always" }, price: 150, drop: true, story: "An honest wooden barrel." },
  { id: "stacked-barrels", name: "Stacked Barrels", emoji: "🛢️", rarity: "uncommon", category: "case",
    spriteKey: "deco/stacked-barrels", unlock: { kind: "always" }, price: 260, drop: true, story: "Provisions, neatly stacked." },
  { id: "supply-crate", name: "Supply Crate", emoji: "📦", rarity: "common", category: "case",
    spriteKey: "deco/supply-crate", unlock: { kind: "always" }, price: 160, drop: true, story: "What's inside? Who knows." },
  { id: "supply-crates", name: "Supply Crates", emoji: "📦", rarity: "uncommon", category: "case",
    spriteKey: "deco/supply-crates", unlock: { kind: "always" }, price: 280, drop: true, story: "A merchant's whole haul." },
  { id: "treasure-chest", name: "Treasure Chest", emoji: "🧰", rarity: "rare", category: "case",
    spriteKey: "deco/treasure-chest", unlock: { kind: "always" }, price: 480, drop: true, story: "Locked, of course." },
  { id: "log-pile", name: "Log Pile", emoji: "🪵", rarity: "common", category: "monument",
    spriteKey: "deco/log-pile", unlock: { kind: "always" }, price: 140, drop: true, story: "Firewood for long nights." },
  { id: "feast-table", name: "Feast Table", emoji: "🍽️", rarity: "rare", category: "statue",
    spriteKey: "deco/feast-table", unlock: { kind: "always" }, price: 560, drop: true, story: "Set for a hero's welcome." },
  { id: "study-table", name: "Study Table", emoji: "🪑", rarity: "uncommon", category: "statue",
    spriteKey: "deco/study-table", unlock: { kind: "always" }, price: 340, drop: true, story: "For plotting your next set." },
  { id: "officer-chair", name: "Officer Chair", emoji: "🪑", rarity: "common", category: "statue",
    spriteKey: "deco/officer-chair", unlock: { kind: "always" }, price: 180, drop: true, story: "A solid dungeon chair." },
  { id: "round-table", name: "Round Table", emoji: "⭘", rarity: "uncommon", category: "statue",
    spriteKey: "deco/round-table", unlock: { kind: "always" }, price: 300, drop: true, story: "Gather round." },
  { id: "dining-set", name: "Dining Set", emoji: "🍽️", rarity: "rare", category: "statue",
    spriteKey: "deco/dining-set", unlock: { kind: "always" }, price: 520, drop: true, story: "Table and chairs, ready for a feast." },
  { id: "briefing-table", name: "Briefing Table", emoji: "🗺️", rarity: "uncommon", category: "statue",
    spriteKey: "deco/briefing-table", unlock: { kind: "always" }, price: 360, drop: true, story: "Short table with seats for planning." },
  { id: "stone-column", name: "Stone Column", emoji: "🏛️", rarity: "common", category: "monument",
    spriteKey: "deco/stone-column", unlock: { kind: "always" }, price: 200, drop: true, story: "Architectural presence." },
  { id: "wood-column", name: "Wood Column", emoji: "🪵", rarity: "common", category: "monument",
    spriteKey: "deco/wood-column", unlock: { kind: "always" }, price: 180, drop: true, story: "Timber support for your halls." },
  { id: "archway-deco", name: "Stone Archway", emoji: "🚪", rarity: "uncommon", category: "monument",
    spriteKey: "deco/archway-deco", unlock: { kind: "shop" }, price: 400, drop: true, story: "A freestanding arch for drama." },
  { id: "door-frame", name: "Open Door", emoji: "🚪", rarity: "uncommon", category: "monument",
    spriteKey: "deco/door-frame", unlock: { kind: "shop" }, price: 320, drop: true, story: "Invite guests in." },
  { id: "window-bay", name: "Window Wall", emoji: "🪟", rarity: "uncommon", category: "monument",
    spriteKey: "deco/window-bay", unlock: { kind: "shop" }, price: 340, drop: true, story: "Let the light in." },
  { id: "stairs-deco", name: "Stone Stairs", emoji: "📶", rarity: "rare", category: "monument",
    spriteKey: "deco/stairs-deco", unlock: { kind: "shop" }, price: 480, drop: true, story: "A hint of another floor." },
  { id: "barrels-stacked-tall", name: "Tall Barrel Stack", emoji: "🛢️", rarity: "uncommon", category: "case",
    spriteKey: "deco/barrels-stacked-tall", unlock: { kind: "always" }, price: 280, drop: true, story: "Provisions stacked high." },
  { id: "treasure-chest-open", name: "Open Chest", emoji: "✨", rarity: "rare", category: "case",
    spriteKey: "deco/treasure-chest-open", unlock: { kind: "shop" }, price: 520, drop: true, story: "Showing off the loot." },

  // ── Mini figurines / staff (Kenney isometric characters) ─────────────────────
  { id: "figure-knight", name: "Knight Figurine", emoji: "🛡️", rarity: "uncommon", category: "statue",
    spriteKey: "deco/figure-knight", unlock: { kind: "always" }, price: 220, drop: true, story: "A sworn guardian on duty." },
  { id: "figure-mage", name: "Mage Figurine", emoji: "🔮", rarity: "uncommon", category: "statue",
    spriteKey: "deco/figure-mage", unlock: { kind: "always" }, price: 220, drop: true, story: "Crackling with power." },
  ...
  { id: "figure-ranger", name: "Ranger Figurine", emoji: "🏹", rarity: "uncommon", category: "statue",
    spriteKey: "deco/figure-ranger", unlock: { kind: "always" }, price: 240, drop: true, story: "Keeps watch from the shelf." },
  ...
  { id: "npc-aide", name: "HQ Aide", emoji: "🫡", rarity: "common", category: "statue",
    spriteKey: "deco/npc-aide", unlock: { kind: "always" }, price: 150, drop: true, story: "Staffs your command center." },
  { id: "npc-scout", name: "HQ Scout", emoji: "🧭", rarity: "common", category: "statue",
    spriteKey: "deco/npc-scout", unlock: { kind: "always" }, price: 150, drop: true, story: "Always watching the grounds." },

  // ── Rugs & lighting (soft-furnishing shop stock) ──────────────────────────────
  { id: "plush-rug", name: "Plush Rug", emoji: "🟪", rarity: "uncommon", category: "rug",
    spriteKey: "deco/plush-rug", unlock: { kind: "always" }, price: 240, drop: true, story: "Deep pile — a little luxury underfoot." },
  { id: "royal-runner", name: "Royal Runner", emoji: "🟥", rarity: "rare", category: "rug",
    spriteKey: "deco/royal-runner", unlock: { kind: "always" }, price: 420, drop: true, story: "Roll it out for distinguished guests." },
  { id: "command-rug", name: "Command Rug", emoji: "🟥", rarity: "uncommon", category: "rug",
    spriteKey: "deco/command-rug", unlock: { kind: "always" }, price: 280, drop: true, story: "House colours underfoot." },
  { id: "vault-rug", name: "Vault Rug", emoji: "🟨", rarity: "rare", category: "rug",
    spriteKey: "deco/vault-rug", unlock: { kind: "shop" }, price: 380, drop: true, story: "Gold-thread for the treasury." },
