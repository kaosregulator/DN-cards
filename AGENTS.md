...
- Published hosts auto-enable Discord login when `REPLIT_DEPLOYMENT=1`, any `RAILWAY_*` service env is present, or `DN_DEPLOYMENT=1`. See `docs/railway.md` for Railway Postgres + secrets.
